...
def solve():  # called when button "solve" is clicked
    ...
    print("time for solving:", time.time()-t0)
    insert_sudoku(solved_sudoku)  # insert the solved sudoku into the GUI grid
...
def import_sudoku():  # called when button "open" is clicked
    ...
    file = filedialog.askopenfile(mode="r", initialdir="/", title="Sudoku auswählen", filetypes=files)
